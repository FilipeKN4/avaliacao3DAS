...
public class Viagem {
	...
	public int getDuracaoHoras() {
		DuracaoHoras horas = new DuracaoHoras(horaInicio, horaTermino, minutosInicio, minutosTermino, duracaoHoras);
		duracaoHoras = horas.calculaDuracaoHoras();
		
		return duracaoHoras;
	}

	public int getDuracaoMinutos() {
		DuracaoMinutos minutos = new DuracaoMinutos(minutosTermino, minutosInicio, duracaoMinutos);
		duracaoMinutos = minutos.calculaDuracaoMinutos();
